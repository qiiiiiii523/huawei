...
from ecg12gen.b2_data import build_pseudo_dataset, build_strict_dataset, build_weak_dataset, fit_b2_preprocessor
from ecg12gen.b2_model import B2MaskedPatchTransformer
from ecg12gen.b2_train import check_weak_protocol_compatibility, fit_b2
...
def main() -> None:
    ...
    checkpoint = fit_b2(
        B2MaskedPatchTransformer(), strict, validation, preprocessor.scale_uV_by_source["d12"], args.task_id,
