...
def main():
    ...
    snapshot.mkdir()
    for relative in [
        "scripts/train_b0_joint_task2_p1_c3.py", "ecg12gen/models/b0_joint_anchor.py",
    ...
    with (output / "training_log.csv").open("w", encoding="utf-8", newline="") as handle:
        ...
        for epoch in range(1, epochs + 1):
            ...
            print(
                f'P1-C3-{args.variant} | Epoch {epoch}/{epochs} | loss={row["loss"]:.6f} | '
